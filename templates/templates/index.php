...
<body>
        ...
        <div class="hero-container">
            ...
            <div class="hero-slider">
                <div class="slider-wrapper">
                    <div class="slide active" style="background-image: url('images/adminn.jpg')">
                        <div class="slide-overlay"></div>
                        <div class="slide-content">
                            <h3>Современные решения<br>для развития округа</h3>
                        </div>
                    </div>
                    <div class="slide" style="background-image: url('images/admin2.jpg')">
                        <div class="slide-overlay"></div>
                        <div class="slide-content">
                            <h3>Инновационные проекты<br>и социальные программы</h3>
                        </div>
                    </div>
                    <div class="slide" style="background-image: url('images/admin3.jpg')">
                        <div class="slide-overlay"></div>
                        <div class="slide-content">
                            <h3>Инновационные проекты<br>и социальные программы</h3>
                        </div>
            ...
            <div class="hero-contacts">
                <div class="contact-card">
                    <div class="card-header">
                        ...
                        <h2>Администрация округа</h2>
                    </div>
                    <div class="card-body">
                        <div class="contact-item">
                            <i class="fas fa-map-marker-alt"></i>
                            <p>659220, Залесовский муниципальный округ,<br>
                                с. Залесово, ул. Партизанская, 26</p>
                        </div>
                        <div class="contact-item">
                        ...
                        <div class="contact-item">
                            ...
                            <p>adm01212@mail.ru</p>
                        </div>
                        <div class="contact-item">
                            <i class="fas fa-user-tie"></i>
                            <p>Глава округа:<br>Пластеев Александр Валерьевич</p>
                        </div>
                    </div>
                    <div class="card-footer">
                        <button class="btn contact-btn" onclick="">
                            <i class="fas fa-paper-plane"></i> Написать обращение
                        </button>
                    </div>
                </div>
            </div>
    ...
    <main class="content-container">
        ...
        <section class="section-services">
            <h2 class="section-title">Государственные услуги</h2>
